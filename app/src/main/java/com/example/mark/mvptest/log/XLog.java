package com.example.mark.mvptest.log;


import android.text.TextUtils;
import android.util.Log;

import com.example.mark.mvptest.common.Config;
...
public class XLog {
    ...
    public static boolean LOG = Config.LOG;
    public static String TAG_ROOT = Config.LOG_TAG;
